...
import { Constant, forumPageAccess } from '../../../common/constant/constant';
...
this.escalationCount=rsescalationCount;
  ...
  {
    let url = `${forumPageAccess.threadpageNew}${Id}`
    let flag: any = true;
    this.newPageAccess = false;
    if(this.newPageAccess){
      ...
      setTimeout(() => {
        ...
        scrollTop = 530;
        this.CommonServiceAPI.setlocalStorageItem('homeScroll', scrollTop);
      }, 50);
