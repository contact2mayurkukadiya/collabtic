...
import { Constant,windowHeight,ContentTypeValues,DefaultNewImages,DefaultNewCreationText,IsOpenNewTab } from 'src/app/common/constant/constant';
...
export class AnnouncementListComponent implements OnInit {
  ...
  navUrl(event,action,Id,type) {
    ...
    if(this.teamSystem) {
      localStorage.setItem('annType', this.announceType);
  ...
  updateLayout() {
    ...
    removeArchiveAccouncement(id){
      this.viapushcall=true;
      for (var j in this.announceList) { 
