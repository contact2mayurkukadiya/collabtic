...
export class DetailViewComponent implements OnInit {
  ...
  constructor(private announcementService: AnnouncementService, private authenticationService:AuthenticationService,private modalService: NgbModal,) { }
  ...
  ngOnInit(): void { 
   ...
   getThreadInfo(){
    ...
    if(this.threadViewData.description != 'null' && this.threadViewData.description != '' && this.threadViewData.description != null){
      this.threadViewData.description=this.authenticationService.convertunicode(this.authenticationService.ChatUCode(this.threadViewData.description));
    }
