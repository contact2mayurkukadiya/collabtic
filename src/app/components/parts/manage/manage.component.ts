...
import { Constant, ContentTypeValues, IsOpenNewTab, pageInfo, PlatFormType, pageTitle, RedirectionPage, windowHeight } from '../../../common/constant/constant';
