        ...
        for (var opt of options) {
          ...
          switch (wid) {
            ...
            case 3:
              ...
              for (var year of opt.valueArray) {
            ...
            case 6:
              ...
              if (opt.value != 'undefined' && opt.value != undefined) {
                ...
                this.startDateValue = moment().subtract(30, 'days').format();
                this.filteredData['startDate'] = moment().subtract(30, 'days').format('YYYY-MM-DD');
              }
              break;
            case 7:
            ...
            case 10:
              ...
              this.endDateId = wid;
              if (!opt.value && this.filterOptions.page == 'leaderboard') {
  ...
  getDealerUsers() {
    ...
    this.dashboardApi.apiChartDetail(this.apiData).subscribe((response) => {
      if (response.status == "Success") {
        ...
        //let dlist = [{'dealerName': 'All Users', 'dealerCode': ''}];
        let dlist = [];
        for (var dealer of dealerListData) {
