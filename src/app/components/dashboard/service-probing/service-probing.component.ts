...
export class ServiceProbingComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.titleService.setTitle('Mahle Forum - Dashboard '+this.headTitle);
  }
        ...
        for(var res in responseData) {
          ...
          switch(wid) {
            ...
            case 2:
              ...
              for(var u of this.userTypesArr) {
              ...
              for(var u of this.userTypesArr) {                
                if(utypeVal == u.id) {
                  ...
                  this.titleService.setTitle('Mahle Forum - Dashboard '+serviceTitle);
                }                
              }
              break;
            case 6:
  ...
  getserviceProbingData(apiData) {
    ...
    this.dashboardApi.apiChartDetail(apiData).subscribe((response) => {
      if(response.status == "Success") {
        ...
        /*let userList = [];
        for(var dealer of serviceProbingData) {
