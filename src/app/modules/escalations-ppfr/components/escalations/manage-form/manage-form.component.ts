...
export class ManageFormComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if(this.serviceHistoryFormInfo.length>1){
      ...
      for (var v in this.serviceHistoryFormInfo) {
      ...
      for (var v in this.ppfrForm.value.serviceHistoryInfo) {
        let newDate = "";
    ...
    if(this.occuranceFormInfo.length>1){
      ...
      for (var v in this.occuranceFormInfo) {
        let indexVal = parseInt(v) + 1;
      ...
      for (var o in this.ppfrForm.value.occuranceInfo) {
    ...
    partFormData.append("country", this.country);
  ...
  checkFields(){
    ...
    if(this.severities !='' || this.dealerName !=''  || this.country != '' || this.location !='' || this.model != '' || this.engineNumber != '' || this.frameNumber != '' || this.KMSReading != '' || this.partNumber != '' || this.description != '' || this.location != '' || this.partNumber !='' || this.qty !=''){           
      this.saveButtonEnable = true;
      console.log(this.saveButtonEnable);
    }
    else{
