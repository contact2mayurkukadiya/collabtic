...
export class ExcelService {
  ...
  exportAllThreads(title, exportData,threadListHeader1,workstreamdIds)
  {
   ...
   for(var threadList in userThreadListData) {
...
worksheet.properties.defaultRowHeight = 20;
  ...
  */
  ...
  exportAllUsers(title, exportData,threadListHeader1,workstreamdIds,domainId)
  {
   ...
   threadListHeader=threadListHeader1;
   let userDashLists = [];
   for(var userList in userListData) {
   ...
   {
    userListInfo = [ULoginID,UFirstName,ULastName,UEmailAddress,UIsVerified,UuserRole,Uisactive,locallastupdatedDate,UbussTitle,UbusinessRole,UUsername,Ucreated_on,UManagerName];
   }
